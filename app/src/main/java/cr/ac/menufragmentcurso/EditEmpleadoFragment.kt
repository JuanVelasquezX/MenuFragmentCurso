...
class EditEmpleadoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val nombre=view.findViewById<TextView>(R.id.empleado)
        nombre.setText(empleado?.nombre)

        val identificacion=view.findViewById<TextView>(R.id.empleado_id)
        identificacion.setText(empleado?.identificacion)

        val puesto=view.findViewById<TextView>(R.id.empleado_puesto)
        puesto.setText(empleado?.puesto)

        val departamento=view.findViewById<TextView>(R.id.empleado_departamento)
        departamento.setText(empleado?.departamento)

        img_avatar = view.findViewById(R.id.avatar)


        view.findViewById<Button>(R.id.btnEliminar).setOnClickListener{ Eliminar(1) }
        view.findViewById<Button>(R.id.btnModificar).setOnClickListener{ Editar(identificacion.text.toString()) }
    ...
    fun Editar(identificacion:String){
        ...
        val edit_nombre = view?.findViewById<TextView>(R.id.empleado)
        val edit_puesto = view?.findViewById<TextView>(R.id.empleado_puesto)
        val edit_departamento = view?.findViewById<TextView>(R.id.empleado_departamento)
